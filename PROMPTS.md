...
## `dermatologos-athanasios-chrysospathis.webp` — 4:5 portrait
...
## `iatreio-eisodos-peraia.webp` — the entrance · 4:5 portrait
...
## `iatreio-ypodochi.webp` — reception · 4:5 portrait
...
## `iatreio-anamoni.webp` — the waiting area · 4:5 portrait
...
## `iatreio-exetastirio.webp` — the examination room · 4:5 portrait
...
## `dermatoskopio-macro.webp` — dermatoscope, macro · 4:5 portrait
...
## `iatreio-diadromos.webp` — corridor detail · 4:5 portrait
