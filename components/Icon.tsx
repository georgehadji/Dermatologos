/**
 * The four icons the site needs, drawn inline (Lucide-style, 1.5 stroke).
 * Four paths do not justify an icon dependency, and inline SVG inherits
 * `currentColor`, so every icon follows the text it sits next to.
 */
