...
export default function ScrollProgress() {
  ...
  return (
    <button
      ...
      className="fixed bottom-24 right-6 z-50 grid size-12 cursor-pointer place-items-center rounded-full bg-paper-2/80 backdrop-blur transition-[opacity,transform] t-slow hover:scale-110 md:bottom-10 md:right-10"
    >
