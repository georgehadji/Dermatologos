...
/**
 * True once it is both safe and worthwhile to mount a canvas: WebGL exists, the
 * visitor has not asked for reduced motion, and we are past first paint so the
 * shader compile does not compete with LCP.
 */
